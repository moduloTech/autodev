...
- **Réinitialiser** — relance la demande. Si Autodev n'avait pas encore ouvert de *Merge Request*, elle repart de zéro ; s'il en avait déjà ouvert une, elle reprend à la vérification de la *Merge Request* existante plutôt que de tout refaire. Quand Autodev avait renoncé et vous avait rendu le ticket, il **le reprend** au moment où vous relancez, et le dit sur le ticket en vous nommant : il vous le rendra à la fin. Sans cela il repartait au travail sur un ticket qui n'était plus le sien, s'arrêtait au tour suivant, et annonçait à tort que quelqu'un l'avait retiré de la demande.
