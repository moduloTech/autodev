...
# Solid Queue tables — verbatim port of solid_queue 1.4.0's queue_schema.rb,
# wrapped as a numbered migration so config/initializers/auto_migrate.rb can
# run it against the `queue` connection at boot.
#
# If solid_queue ships schema changes in a future release, add a new
# 2026MMDDxxxxxx_*.rb migration alongside this one rather than editing it.
